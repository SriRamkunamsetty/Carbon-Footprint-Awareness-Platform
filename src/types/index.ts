 ...
 * All interfaces use strict typing — no `any` types.
 */
...
export interface UserProfile {
  ...
  points: number;
  /** Monthly carbon emission goal in kg CO₂ */
  goal: number;
  ...
  onboarded: boolean;
  /** Monthly carbon emissions in kg CO₂ */
...
export interface DailyLog {
  ...
  /** Total carbon emissions in kg CO₂ */
  totalCarbon: number;
  /** Creation timestamp */
  createdAt: TimestampLike;
}
...
export interface EcoGoal {
  ...
  /** Target reduction in kg CO₂ */
  targetValue: number;
  /** Current reduction achieved in kg CO₂ */
  currentValue: number;
  /** Goal deadline */
...
/** Weekly report generated by Cloud Functions */
export interface WeeklyReport {
  ...
  /** Total carbon for the week in kg CO₂ */
  totalCarbon: number;
  /** Category breakdown */
...
export interface TwinResults {
  /** Current monthly carbon in kg CO₂ */
  currentCarbon: number;
  /** Projected monthly carbon in kg CO₂ */
  projectedCarbon: number;
  /** Monthly savings in kg CO₂ */
